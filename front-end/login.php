<?php
  ...
  //비밀번호 암호화
  $userPw = sha1("extrapassword".$_POST['userPw']);
  ...
  if($res->num_rows == 1){
    ...
    $_SESSION['myMemberSes']['studentID'] = $memberInfo['studentID'];
    ...
    if(isset($_SESSION['myMemberSes'])){
      ...
      echo "<script>alert('아이디 혹은 비밀번호가 틀립니다.');location.href='/myservice/';</script>";
  }
?>
